...
def load_gui(self):
    ...
    self.txt_browse1.grid(row=1,column=1,rowspan=1,columnspan=1,padx=(35,45),pady=(30,0),sticky=E)
    self.txt_browse2 = tk.Entry(self.master,text='')
    self.txt_browse2.grid(row=2,column=1,rowspan=1,columnspan=1,padx=(35,45),pady=(12,0),sticky=N+E+W)
    ...
    self.btn_browse1.grid(row=1,column=0,padx=(18,0),pady=(30,0),sticky=W)
    self.btn_browse2 = tk.Button(self.master,width=12,height=1,text='Browse...')
    self.btn_browse2.grid(row=2,column=0,padx=(18,0),pady=(10,0),sticky=W)
    self.btn_checkForFiles = tk.Button(self.master,width=12,height=2,text='Check for files...')
    self.btn_checkForFiles.grid(row=3,column=0,padx=(18,0),pady=(10,0),sticky=W)
    ...
    self.btn_checkForFiles.grid(row=3,column=1,columnspan=1,padx=(35,45),pady=(10,0),sticky=E)
