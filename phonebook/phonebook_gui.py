...
def load_gui(self): #first function that uses the self key
    ...
    self.txt_fname.grid(row=,column=,rowspan=,columnspan,padx(30,40),pady(0,0),sticky=N+E+W)
    self.txt_lname = tk.Entry(self.master,text='')
    self.txt_lname.grid(row=,column=,rowspan=,columnspan,padx(30,40),pady(0,0),sticky=N+E+W)
    self.txt_phone = tk.Entry(self.master,text='')
    self.txt_phone.grid(row=,column=,rowspan=,columnspan,padx(30,40),pady(0,0),sticky=N+E+W)
    self.txt_email = tk.Entry(self.master,text='')
    self.txt_email.grid(row=,column=,rowspan=,columnspan,padx(30,40),pady(0,0),sticky=N+E+W)

    #Define the listbox with a scrollbar and grid them
    self.scrollbar1 = Scrollbar(self.master,orient-VERTICAL)
    self.lstList1 = Listbox(self.master,exportselection=0,yscrollcommand=self.scrollbar1.set)
    self.lstList1.bind('<<ListboxSelect>>',lambda event: phonebook_fun.onSelect(self,event)) #calling the eventlestboxselect
